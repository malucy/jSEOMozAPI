 ...
 */
class SeomozapiControllerRequest extends SeomozapiController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Request', 'SeomozapiModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_seomozapi&view=requestform&layout=edit', false));
	}
